...
export function Activities() {
  return (
    <section id="activities" className="section-shell content-section">
      <MotionReveal><SectionHeading index="04" eyebrow="Activities & contributions / กิจกรรม" title="Learning happens everywhere." description="Competitions, clubs, volunteer work, seminars, and the impact or role in each activity." /></MotionReveal>
          ...
          <MotionReveal key={activity.title} delay={index * 0.06}>
            <article className="activity-card">
              ...
              <div className="activity-body">
                ...
                <h3>{activity.title}</h3><span className="activity-org"><Building2 size={14} />{activity.organization}</span><p>{activity.description}</p>
